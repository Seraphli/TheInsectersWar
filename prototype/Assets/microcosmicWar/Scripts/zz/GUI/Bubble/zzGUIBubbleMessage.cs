...
public class zzGUIBubbleMessage:MonoBehaviour
{
    ...
    public zzGUIBubbleIconMessage bubbleIconMessage;
        ...
        Color pColor, Rect pRect)
    {
        ...
        var lNewAdded = bubbleIconMessage
            .addBubble(pTransform,bubblePrefab,out lBubble);
        var lMessageBox = lBubble.GetComponent<zzGUIBubbleMessageBox>();
        if (lNewAdded)
        {
